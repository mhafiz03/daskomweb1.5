...
class SoalTkController extends Controller
{
    ...
    {
        $request->validate([
            'pertanyaan' => 'required|unique:soal_tks|string',
            'modul_id' => 'required',
        ...
        $id = SoalTk::where('pertanyaan', $request->pertanyaan)->first()->id;
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SoalTk $soal_Tk)
    {
        //
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->pertanyaan != $request->oldPertanyaan) {
            foreach (SoalTk::all() as $soal => $value) {
    ...
    /**
     * Get specific TK questions by their IDs
    ...
    public function getByIds(Request $request)
    {
        ...
        try {
            $questions = SoalTk::where('modul_id', $modulId)
