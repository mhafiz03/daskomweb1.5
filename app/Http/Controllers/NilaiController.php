...
class NilaiController extends Controller
{
    ...
    public function index($praktikan_id, $modul_id)
    {
        if($modul_id == 1){
            ...
            $allJawabanTa = JawabanTa::where('praktikan_id', $praktikan_id)
            ...
            $allJawabanTk = JawabanTk::where('praktikan_id', $praktikan_id)
                ->where('modul_id', $modul_id)
                ->get();
    ...
    public function edit($praktikan_nim, $asisten_id, $modul_id)
    {
        ...
        if(LaporanPraktikan::where("praktikan_id", Praktikan::where("nim", $praktikan_nim)->first()->id)
        ...
        if(LaporanPraktikan::where("praktikan_id", Praktikan::where("nim", $praktikan_nim)->first()->id)
            ...
            $currentLaporan = LaporanPraktikan::where("praktikan_id", Praktikan::where("nim", $praktikan_nim)->first()->id)
